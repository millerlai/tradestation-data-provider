...
|---|---|---|---|---|
| T3 | `bindings/python/tests/test_history_store.py:7` | Regression test for "load_bars never derives from ticks" was deleted, no replacement | ⬜ | |
| T4 | `docs/architecture.md:498` | Table row contradicts the row above it on interval refusal | ⬜ | |
| T5 | `EL/README.md:100`, `EL/README.zh-TW.md` | "Supported chart intervals" table still describes deleted refuse/idle/-5 model | ⬜ | |
