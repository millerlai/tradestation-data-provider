...
| 檔案 | 內容 |
| --- | --- |
| [`v1/envelope.md`](v1/envelope.md) | frame 結構與 payload 格式 |
| [`v1/tick.schema.json`](v1/tick.schema.json) | `EL_PublishTick` payload |
| [`v1/bar_1m.schema.json`](v1/bar_1m.schema.json) | `EL_PublishTickEx` payload |
